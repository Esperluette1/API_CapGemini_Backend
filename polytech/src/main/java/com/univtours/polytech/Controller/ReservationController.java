...
public class ReservationController {
    ...
    // READ unitaire
    @GetMapping("/{id}")
    public ResponseEntity<ReservationDTO> getReservations(@PathVariable int id) {
    ...
    public ResponseEntity<List<ReservationDTO>> getAllReservations() {
        ...
        List<ReservationDTO> dtos = entities.stream().map(reservationMapper::toDTO).toList();
    ...
    public ResponseEntity<Void> updateUser(
        ...
        Reservation entity = reservationMapper.toEntity(dto);
        reservationService.updateReservation(entity.getUtilisateur_id(), entity.getTerrain_id(), entity.getReservation());
